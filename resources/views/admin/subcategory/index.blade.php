...
<div class="wrapper mx-20">
    <h1>SubCategories</h1>
    <div><a class="text-blue-500 bg-green-300" href="{{ route('admin.subcategoryCreate') }}">Create</a></div>
...
{{--        <p>Category...: {{ $subcategory->id_category }}</p>--}}
        ...
        <div><a class="text-blue-500 bg-blue-300" href="{{ route('admin.subcategoryShow', $subcategory->id) }}">Show</a></div>
    ...
    <form action="{{ route('admin.subcategoryRestore') }}" method="post">
        @csrf
        @method('patch')

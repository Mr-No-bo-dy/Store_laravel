...
<div class="mx-20">
    ...
    <div>
        <a class="text-blue-500 bg-yellow-300" href="{{ route('admin.subcategory.edit', $subcategory->id) }}">Edit</a>
    </div>
    <form action="{{ route('admin.subcategory.destroy') }}" method="post">
        ...
        <button class="text-blue-500 bg-red-500" type="submit" name="destroySubcategory" value="1">Destroy
            Subcategory
        </button>
    </form>
</div>
